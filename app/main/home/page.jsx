...
function Home() {
  return (
    <>
      <div className="bg-[#070619] px-5 text-white">
        <div className="flex justify-between items-stretch">
            <div className="flex">
<FaCircleUser size={30}/>
<div>
    <div className="text-xs text-[#ffffffd2] flex">Hello, Milad <WavingHandSVG /></div>
    <div className="text-[#FBFBFB] text-sm">Welcome to <span className="text-white text-base font-bold">
        wllt
        </span>
          </div>
</div>
