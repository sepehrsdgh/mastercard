...
function EllipsPurple() {
  return (
    <div className="relative">  
      ...
      className="absolute right-[6%] top-[10vh] w-[75vw] h-[35vh]  rounded-full blur-[2rem]"></div>
    </div>
  );
}
    ...
    return (
      <div className="relative">
        ...
        style={{
         ...
         className="absolute left-[10%] top-[30vh] w-[60vw] h-[30vh] rounded-full blur-[3rem]"></div>
      </div>
    );
  }
